...
switch affinity_type
    case 'local_PCA'
       % [W1,index_mat, S] = affinity.RBF_affnity(feats,params);
        [W1,index_mat, S,IDX_vote,S_tan] = affinity.RBF_affnity_knn_fast(feats,params);
        %% W2 affinity using local tangent space with local PCA
        [Data_PCA,W2,theta] = affinity.locPCA_affnity_fast(feats, IDX_vote, params);
        %index_mat=IDX_vote;
    ...
    case 'Hillinger_affinity'
      ...
      %  [W1, index_mat, S] = affinity.RBF_affnity(feats,params);
        ...
        [W2, W_l]= affinity.Hillinger_affinity( feats, IDX_vote,params); 
        Wc = W1.*W2;
        W = Wc.*Wc';       
    case 'sqeuclidean'  
       % [W1,index_mat, S] = affinity.RBF_affnity(feats,params);
    ...
    case 'Tensor_Voting'
        ...
        [Normal_Space,W2,theta] = affinity.TVG_affinity_knn(feats, IDX_vote, params,S_tan);
        %% Connecting all the points
        Wc = W1.*W2;
        %W=(Wc + Wc')./2;
        W = Wc.*Wc';
